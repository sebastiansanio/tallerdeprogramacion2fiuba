...
$PAGE->set_url('/enrol/manual/manage_aceptar_solicitud.php', array('enrolid'=>$instance->id));
...
$potentialuserselector = new enrol_manual_potential_participant_aprendiz_solicito('addselect', $options);
