...
$string['country'] = 'País';
$string['dni'] = 'DNI';
$string['padron'] = 'Padron-Legajo';
$string['rolsolicitado'] = 'Rol solicitado';
$string['course'] = 'Curso';
...
$string['loginsteps'] = 'Esta es la Red social de la Facultad de Ingeniería de la Universidad de Buenos Aires. Para registrarse debe ingresar los datos solicitados en el formulario. A partir de estos, el administrador del sitio deberá aceptarlo para que pueda comenzar navegar por él.';
...
$string['resetcourse'] = 'Consolidar Cuatrimestre';
