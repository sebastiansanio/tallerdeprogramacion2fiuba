...
$PAGE->set_url('/enrol/manual/manage_aprendiz.php', array('enrolid'=>$instance->id));
...
$potentialuserselector = new enrol_manual_potential_participant_aprendiz('addselect', $options);
